 ...
 */
export declare enum C2SPacketType {
    /**
 ...
 */
export declare enum S2CPacketType {
    ANNOUNCE = "ann",
    INIT = "io-init",
    INIT_TRIBES = "id",
    SET_SID = "1",
...
export declare type RawPacket = [C2SPacketType | S2CPacketType, [...any[]]];
export declare type RawC2SPacket = [C2SPacketType, [...any[]]];
export declare type RawS2CPacket = [S2CPacketType, [...any[]]];
